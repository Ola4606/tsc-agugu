  ...
  return (
    <div className="text-justify mt-20">
      ...
      <ul className="list-disc list-inside font-light font-causal">
        ...
        <li>
          <span>
            He is <span className="font-semibold">The Stone</span> of Israel.{" "}
            <span className="bible-verse text-base">~Genesis 49:24</span>
          </span>
        </li>
        <li>
          <span>
            He is <span className="font-semibold">The Stone</span> that falls on
            you such that it will crush you to powder and that when you fall on

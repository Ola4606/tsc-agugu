...
function WhoWeAre() {
  return (
    <div
      className="bg-center bg-no-repeat bg-[length:auto_500px] mt-20"
      style={{ backgroundImage: `url(${TestImage})` }}
    >
      <div className="bg-white/[.50] min-h-[500px] flex justify-center items-center">
        <div className="xsm:max-w-[350px] sm:max-w-[450px] md:max-w-[500px] lg:max-w-[650px] xl:max-w-[750px] text-center text-lg">
